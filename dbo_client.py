...
def choose_suggestion(elem, type):
    alpha = ['А', 'Б', 'В', 'Г', 'Д', 'Е', 'З', 'И', 'К', 'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Х', 'Ц',
             'Ч', 'Э', 'Ю', 'Я']
    elem.click()
    if type == 'char':
...
driver.get(url + 'cards/svoya-debet')
time.sleep(2)
